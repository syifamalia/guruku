...
<head>
    ...
    <script type="text/javascript" src="/admins/js/admins.js"></script>

    {{-- Icon --}}
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css">

    {{-- Trix Editor --}}
    <link rel="stylesheet" type="text/css" href="/admins/css/trix.css">
    <script type="text/javascript" src="/admins/js/trix.js"></script>
