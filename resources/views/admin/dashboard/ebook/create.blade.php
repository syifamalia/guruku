...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">E-book Baru</h1>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary float-sm-left mt-1">Buat Data E-book Baru</h6>
                ...
                <div class="card-body">
                    <form method="post" action="/dashboard/ebook" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          <label for="tittle" class="col-sm-2 col-form-label">Judul E-book</label>
                          <div class="col-sm-8">
                            <input type="text" class="form-control @error('tittle') is-invalid @enderror" id="tittle" placeholder="Masukan judul e-book" name="tittle" value="{{ old('tittle') }}">
                            @error('tittle')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control @error('author') is-invalid @enderror" id="author" placeholder="Masukan nama penulis" name="author" value="{{ old('author') }}">
                              @error('author')
                                  <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="synopsis" class="col-sm-2 col-form-label">Sipnosis Singkat</label>
                            <div class="col-sm-8">
                              <textarea class="form-control @error('synopsis') is-invalid @enderror" id="synopsis" name="synopsis" rows="4" placeholder="Masukkan sinopsis singkat. Maks 200 kata.">{{ old('synopsis') }}</textarea>
                              @error('synopsis')
